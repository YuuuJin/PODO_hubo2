...
public:
    ...
    void setupUi(QMainWindow *GUIMainWindow)
    {
        ...
        MAIN_TAB->setGeometry(QRect(10, 90, 767, 841));
...
""));
    ...
    void retranslateUi(QMainWindow *GUIMainWindow)
    {
        ...
        actionMODEL->setText(QApplication::translate("GUIMainWindow", "MODEL Pannel", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionMODEL->setToolTip(QApplication::translate("GUIMainWindow", "MODEL Pannel", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
