...
public:
    ...
    {
        LANDialog->setWindowTitle(QApplication::translate("LANDialog", "LAN Dialog", Q_NULLPTR));
        BTN_LAN_CONNECT->setText(QApplication::translate("LANDialog", "Connect", Q_NULLPTR));
        label->setText(QApplication::translate("LANDialog", "LAN Setting", Q_NULLPTR));
        LE_PORT_NUM->setText(QApplication::translate("LANDialog", "4000", Q_NULLPTR));
        LE_IP_ADDR->setText(QApplication::translate("LANDialog", "127.127.127.127", Q_NULLPTR));
    } // retranslateUi
