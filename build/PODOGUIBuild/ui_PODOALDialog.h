...
public:
    ...
    {
        PODOALDialog->setWindowTitle(QApplication::translate("PODOALDialog", "Dialog", Q_NULLPTR));
        BTN_OPEN_PROCESS->setText(QApplication::translate("PODOALDialog", "Open Process", Q_NULLPTR));
        label->setText(QApplication::translate("PODOALDialog", "PODO AL Setting", Q_NULLPTR));
        BTN_CLOSE_PROCESS->setText(QApplication::translate("PODOALDialog", "Close Process", Q_NULLPTR));
    } // retranslateUi
