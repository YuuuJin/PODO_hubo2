...
""));
    ...
    {
        LauncherDialog->setWindowTitle(QApplication::translate("LauncherDialog", "Daemon Launcher", Q_NULLPTR));
        BTN_CHANGE_DAEMON->setText(QApplication::translate("LauncherDialog", "Change\n"
"Daemon", Q_NULLPTR));
        BTN_START_DAEMON->setText(QApplication::translate("LauncherDialog", "Start Daemon", Q_NULLPTR));
        GB_CONTROL->setTitle(QApplication::translate("LauncherDialog", "Daemon Setting", Q_NULLPTR));
        RB_ROS_OK->setText(QApplication::translate("LauncherDialog", "Use ROS", Q_NULLPTR));
        RB_ROS_NO->setText(QApplication::translate("LauncherDialog", "No ROS", Q_NULLPTR));
        RB_FOG_OK->setText(QApplication::translate("LauncherDialog", "Use FOG", Q_NULLPTR));
        RB_FOG_NO->setText(QApplication::translate("LauncherDialog", "No FOG", Q_NULLPTR));
        RB_ROBOT->setText(QApplication::translate("LauncherDialog", "Robot", Q_NULLPTR));
        RB_GAZEBO->setText(QApplication::translate("LauncherDialog", "Gazebo", Q_NULLPTR));
        label->setText(QApplication::translate("LauncherDialog", "Horizontal", Q_NULLPTR));
        label_2->setText(QApplication::translate("LauncherDialog", "Vertical", Q_NULLPTR));
        CB_EXF_R->setText(QApplication::translate("LauncherDialog", "Extra Finger (R)", Q_NULLPTR));
        CB_EXF_L->setText(QApplication::translate("LauncherDialog", "Extra Finger (L)", Q_NULLPTR));
        BTN_STOP_DAEMON->setText(QApplication::translate("LauncherDialog", "Stop Daemon", Q_NULLPTR));
        BTN_CHANGE_GUI->setText(QApplication::translate("LauncherDialog", "Change\n"
"GUI", Q_NULLPTR));
        BTN_START_GUI->setText(QApplication::translate("LauncherDialog", "Start GUI", Q_NULLPTR));
        BTN_STOP_GUI->setText(QApplication::translate("LauncherDialog", "Stop GUI", Q_NULLPTR));
    } // retranslateUi
