...
#include "../../../src/ALPrograms/PODOLAN/PODOServer.h"
...
struct qt_meta_stringdata_RM_Link_Client_t {
    QByteArrayData data[3];
    char stringdata0[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RM_Link_Client_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RM_Link_Client_t qt_meta_stringdata_RM_Link_Client = {
    {
QT_MOC_LITERAL(0, 0, 14), // "RM_Link_Client"
QT_MOC_LITERAL(1, 15, 10), // "RBReadData"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "RM_Link_Client\0RBReadData\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_RM_Link_Client[] = {
...
void RM_Link_Client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RM_Link_Client *_t = static_cast<RM_Link_Client *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->RBReadData(); break;
        default: ;
...
const QMetaObject RM_Link_Client::staticMetaObject = {
    { &RBTCPClient::staticMetaObject, qt_meta_stringdata_RM_Link_Client.data,
      qt_meta_data_RM_Link_Client,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *RM_Link_Client::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *RM_Link_Client::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_RM_Link_Client.stringdata0))
        return static_cast<void*>(const_cast< RM_Link_Client*>(this));
    return RBTCPClient::qt_metacast(_clname);
}

int RM_Link_Client::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
