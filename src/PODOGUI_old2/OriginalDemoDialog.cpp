...
void OriginalDemoDialog::on_btn_head_stretching_clicked(){ ui->btn_head_stretching->setDisabled(true);   }
void OriginalDemoDialog::on_btn_head_init_clicked(){ui->btn_head_init->setDisabled(true);}
...
{
    GeneralCommand(ALNum_Pyeongchang,HANDSHAKE_READY,51);
}

void OriginalDemoDialog::on_btn_hand_gon_clicked()
{
    GeneralCommand(ALNum_Pyeongchang,HANDSHAKE_GRIP_ON,50);
}
...
{
    GeneralCommand(ALNum_Pyeongchang,HANDSHAKE_INIT,-1);
}
...
{
    GeneralCommand(ALNum_Pyeongchang,BOUQUET_GIVE,54);
}
...
{
    GeneralCommand(ALNum_Pyeongchang,GUID_LEFT,52);
    ui->btn_guid_left->setDisabled(true);
}

void OriginalDemoDialog::on_btn_guid_right_clicked()
{
    GeneralCommand(ALNum_Pyeongchang,GUID_RIGHT,53);
    ui->btn_guid_right->setDisabled(true);
}
