...
void ModelDialog::on_BTN_SOUND_1_clicked(){    cout << "Music Number : 1   " << endl; if(ui->rad_kor->isChecked() == true) playdemoSound[1]->play(); else playdemoSound[1+50]->play();   ui->BTN_SOUND_1->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_2_clicked(){   cout << "Music Number : 2   " << endl; if(ui->rad_kor->isChecked() == true) playdemoSound[2]->play(); else playdemoSound[2+50]->play();   ui->BTN_SOUND_2->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_3_clicked(){   cout << "Music Number : 3   " << endl; if(ui->rad_kor->isChecked() == true) playdemoSound[3]->play(); else playdemoSound[3+50]->play();   ui->BTN_SOUND_3->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_4_clicked(){   cout << "Music Number : 4   " << endl; if(ui->rad_kor->isChecked() == true) playdemoSound[4]->play(); else playdemoSound[4+50]->play();   ui->BTN_SOUND_4->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_5_clicked(){   cout << "Music Number : 5   " << endl; if(ui->rad_kor->isChecked() == true) playdemoSound[5]->play(); else playdemoSound[5+50]->play();   ui->BTN_SOUND_5->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_6_clicked(){   cout << "Music Number : 6   " << endl; if(ui->rad_kor->isChecked() == true) playdemoSound[6]->play(); else playdemoSound[6+50]->play();   ui->BTN_SOUND_6->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_7_clicked(){   cout << "Music Number : 7   " << endl; if(ui->rad_kor->isChecked() == true) playdemoSound[7]->play(); else playdemoSound[7+50]->play();   ui->BTN_SOUND_7->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_15_clicked(){  cout << "Music Number : 8   " << endl; if(ui->rad_kor->isChecked() == true) playdemoSound[8]->play(); else playdemoSound[8+50]->play();   ui->BTN_SOUND_15->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_16_clicked(){  cout << "Music Number : 9   " << endl; if(ui->rad_kor->isChecked() == true) playdemoSound[9]->play(); else playdemoSound[9+50]->play();   ui->BTN_SOUND_16->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_17_clicked(){  cout << "Music Number : 10  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[10]->play(); else playdemoSound[10+50]->play();     ui->BTN_SOUND_17->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_18_clicked(){  cout << "Music Number : 11  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[11]->play(); else playdemoSound[11+50]->play();     ui->BTN_SOUND_18->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_19_clicked(){  cout << "Music Number : 12  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[12]->play(); else playdemoSound[12+50]->play();     ui->BTN_SOUND_19->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_20_clicked(){  cout << "Music Number : 13  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[13]->play(); else playdemoSound[13+50]->play();     ui->BTN_SOUND_20->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_21_clicked(){  cout << "Music Number : 14  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[14]->play(); else playdemoSound[14+50]->play();     ui->BTN_SOUND_21->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_22_clicked(){  cout << "Music Number : 15  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[15]->play(); else playdemoSound[15+50]->play();     ui->BTN_SOUND_22->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_23_clicked(){  cout << "Music Number : 16  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[16]->play(); else playdemoSound[16+50]->play();     ui->BTN_SOUND_23->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_24_clicked(){  cout << "Music Number : 17  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[17]->play(); else playdemoSound[17+50]->play();     ui->BTN_SOUND_24->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_25_clicked(){  cout << "Music Number : 18  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[18]->play(); else playdemoSound[18+50]->play();     ui->BTN_SOUND_25->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_26_clicked(){  cout << "Music Number : 19  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[19]->play(); else playdemoSound[19+50]->play();     ui->BTN_SOUND_26->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_27_clicked(){  cout << "Music Number : 20  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[20]->play(); else playdemoSound[20+50]->play();     ui->BTN_SOUND_27->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_28_clicked(){  cout << "Music Number : 21  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[21]->play(); else playdemoSound[21+50]->play();     ui->BTN_SOUND_28->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_29_clicked(){  cout << "Music Number : 22  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[22]->play(); else playdemoSound[22+50]->play();     ui->BTN_SOUND_29->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_30_clicked(){  cout << "Music Number : 23  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[23]->play(); else playdemoSound[23+50]->play();     ui->BTN_SOUND_30->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_31_clicked(){  cout << "Music Number : 24  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[24]->play(); else playdemoSound[24+50]->play();     ui->BTN_SOUND_31->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_32_clicked(){  cout << "Music Number : 25  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[25]->play(); else playdemoSound[25+50]->play();     ui->BTN_SOUND_32->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_33_clicked(){  cout << "Music Number : 26  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[26]->play(); else playdemoSound[26+50]->play();     ui->BTN_SOUND_33->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_34_clicked(){  cout << "Music Number : 27  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[27]->play(); else playdemoSound[27+50]->play();     ui->BTN_SOUND_34->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_35_clicked(){  cout << "Music Number : 28  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[28]->play(); else playdemoSound[28+50]->play();     ui->BTN_SOUND_35->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_36_clicked(){  cout << "Music Number : 29  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[29]->play(); else playdemoSound[29+50]->play();     ui->BTN_SOUND_36->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_37_clicked(){  cout << "Music Number : 30  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[30]->play(); else playdemoSound[30+50]->play();     ui->BTN_SOUND_37->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_38_clicked(){  cout << "Music Number : 31  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[31]->play(); else playdemoSound[31+50]->play();     ui->BTN_SOUND_38->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_39_clicked(){  cout << "Music Number : 32  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[32]->play(); else playdemoSound[32+50]->play();     ui->BTN_SOUND_39->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_40_clicked(){  cout << "Music Number : 33  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[33]->play(); else playdemoSound[33+50]->play();     ui->BTN_SOUND_40->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_41_clicked(){  cout << "Music Number : 34  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[34]->play(); else playdemoSound[34+50]->play();     ui->BTN_SOUND_41->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_42_clicked(){  cout << "Music Number : 35  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[35]->play(); else playdemoSound[35+50]->play();     ui->BTN_SOUND_42->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_43_clicked(){  cout << "Music Number : 36  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[36]->play(); else playdemoSound[36+50]->play();     ui->BTN_SOUND_43->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_44_clicked(){  cout << "Music Number : 37  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[37]->play(); else playdemoSound[37+50]->play();     ui->BTN_SOUND_44->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_45_clicked(){  cout << "Music Number : 38  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[38]->play(); else playdemoSound[38+50]->play();     ui->BTN_SOUND_45->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_46_clicked(){  cout << "Music Number : 39  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[39]->play(); else playdemoSound[39+50]->play();     ui->BTN_SOUND_46->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_47_clicked(){  cout << "Music Number : 40  " << endl;  if(ui->rad_kor->isChecked() == true) playdemoSound[40]->play(); else playdemoSound[40+50]->play();     ui->BTN_SOUND_47->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_100_clicked(){ cout << "Music Number : 100 " << endl;;  playdemoSound[100]->play();    ui->BTN_SOUND_100->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_101_clicked(){ cout << "Music Number : 101 " << endl;;  playdemoSound[101]->play();    ui->BTN_SOUND_101->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_102_clicked(){ cout << "Music Number : 102 " << endl;;  playdemoSound[102]->play();    ui->BTN_SOUND_102->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_103_clicked(){ cout << "Music Number : 103 " << endl;;  playdemoSound[103]->play();    ui->BTN_SOUND_103->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_104_clicked(){ cout << "Music Number : 104 " << endl;;  playdemoSound[104]->play();    ui->BTN_SOUND_104->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_105_clicked(){ cout << "Music Number : 105 " << endl;;  playdemoSound[105]->play();    ui->BTN_SOUND_105->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_88_clicked(){  cout << "Music Number : 106 " << endl;;  playdemoSound[106]->play();    ui->BTN_SOUND_88->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_89_clicked(){  cout << "Music Number : 107 " << endl;;  playdemoSound[107]->play();    ui->BTN_SOUND_89->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_90_clicked(){  cout << "Music Number : 108 " << endl;;  playdemoSound[108]->play();    ui->BTN_SOUND_90->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_91_clicked(){  cout << "Music Number : 109 " << endl;;  playdemoSound[109]->play();    ui->BTN_SOUND_91->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_92_clicked(){  cout << "Music Number : 110 " << endl;;  playdemoSound[110]->play();    ui->BTN_SOUND_92->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_93_clicked(){  cout << "Music Number : 111 " << endl;;  playdemoSound[111]->play();    ui->BTN_SOUND_93->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_94_clicked(){  cout << "Music Number : 112 " << endl;;  playdemoSound[112]->play();    ui->BTN_SOUND_94->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_95_clicked(){  cout << "Music Number : 113 " << endl;;  playdemoSound[113]->play();    ui->BTN_SOUND_95->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_96_clicked(){  cout << "Music Number : 114 " << endl;;  playdemoSound[114]->play();    ui->BTN_SOUND_96->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_97_clicked(){  cout << "Music Number : 115 " << endl;;  playdemoSound[115]->play();    ui->BTN_SOUND_97->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_98_clicked(){  cout << "Music Number : 116 " << endl;;  playdemoSound[116]->play();    ui->BTN_SOUND_98->setEnabled(false);
}void ModelDialog::on_BTN_SOUND_99_clicked(){  cout << "Music Number : 117 " << endl;;  playdemoSound[117]->play();    ui->BTN_SOUND_99->setEnabled(false);
}
...
void ModelDialog::UpdateSensors(){
    QString str;
...
void ModelDialog::on_BTN_SENSOR_FT_NULL_clicked()
{
