    ...
    ui(new Ui::OriginalDemoDialog)
{
    ...
    demoSound[150] = new QSound("../share/hubo_scene/181215_scene1.wav");
    demoSound[151] = new QSound("../share/hubo_scene/181215_scene2.wav");
    demoSound[152] = new QSound("../share/hubo_scene/181215_scene3.wav");
    demoSound[153] = new QSound("../share/hubo_scene/181215_scene4.wav");
...
void OriginalDemoDialog::GeneralCommand(int _TARGET_AL,int motion_num, int sound_num){
    if(motion_num >= 0){
//        FILE_LOG(logWARNING) << "Play Sound : " << sound_num;
        USER_COMMAND cmd;
    ...
    if(sound_num == 140 || sound_num == 141 || sound_num == 145 || true && sound_num!=-1){
        FILE_LOG(logWARNING) << "Play Sound : " << sound_num;
...
/**********************************************************************************/
// Head
void OriginalDemoDialog::on_BTN_HEAD_YES_clicked()      {GeneralCommand(ALNum_Demo,8801, 36);ui->BTN_HEAD_YES->setDisabled(true);ChangeFace(33);}
void OriginalDemoDialog::on_BTN_HEAD_NO_clicked()       {GeneralCommand(ALNum_Demo,8802, 37);ui->BTN_HEAD_NO->setDisabled(true);ChangeFace(34);}
void OriginalDemoDialog::on_BTN_HEAD_QUESTION_clicked() {GeneralCommand(ALNum_Demo,13, 15);ui->BTN_HEAD_QUESTION->setDisabled(true);ChangeFace(41);}
void OriginalDemoDialog::on_btn_head_stretching_clicked(){GeneralCommand(ALNum_Pyeongchang,HEAD_STRETCHING, 35); ui->btn_head_stretching->setDisabled(true);ChangeFace(36);   }
...
void OriginalDemoDialog::on_BTN_MOTION_BOW_clicked()        {GeneralCommand(ALNum_Demo,3, 1);ui->BTN_MOTION_BOW->setDisabled(true);ChangeFace(36);}
void OriginalDemoDialog::on_BTN_MOTION_HAPUM_clicked()      {GeneralCommand(ALNum_Demo,104, -1);ui->BTN_MOTION_HAPUM->setDisabled(true);ChangeFace(35);}
void OriginalDemoDialog::on_BTN_MOTION_ONE_clicked()        {GeneralCommand(ALNum_Demo,105, -1);ui->BTN_MOTION_ONE->setDisabled(true);ChangeFace(17);}
void OriginalDemoDialog::on_BTN_MOTION_TWO_clicked()        {GeneralCommand(ALNum_Demo,106, -1);ui->BTN_MOTION_TWO->setDisabled(true);ChangeFace(18);}
void OriginalDemoDialog::on_BTN_MOTION_THREE_clicked()      {GeneralCommand(ALNum_Demo,107, -1);ui->BTN_MOTION_THREE->setDisabled(true);ChangeFace(19);}
...
void OriginalDemoDialog::on_BTN_MOTION_STORY3_clicked()     {GeneralCommand(ALNum_Demo,108, 2);ui->BTN_MOTION_STORY3->setDisabled(true);ChangeFace(35);}
...
//        ui->BTN_DANCE_PICKME->setDisabled(true);
        ...
        ui->BTN_DANCE_GOGOGO->setDisabled(true);
        ui->BTN_WST_ZERO->setDisabled(true);
        ui->BTN_WST_TWIST->setDisabled(true);
    }
    else
    {
...
//        ui->BTN_DANCE_PICKME->setDisabled(false);
        ...
        ui->BTN_DANCE_GOGOGO->setDisabled(false);
        ui->BTN_WST_ZERO->setDisabled(false);
        ui->BTN_WST_TWIST->setDisabled(false);
    }
...
void OriginalDemoDialog::on_BTN_WST_TWIST_clicked()
{

    USER_COMMAND cmd;
    cmd.COMMAND_TARGET = ALNum_Demo;//_TARGET_AL;
    cmd.COMMAND_DATA.USER_COMMAND = SCI_DEMO;
    cmd.COMMAND_DATA.USER_PARA_INT[3] = WST_TWIST;
    pLAN->SendCommand(cmd);

    ui->BTN_WST_TWIST->setDisabled(true);
}

void OriginalDemoDialog::on_BTN_WST_ZERO_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_TARGET = ALNum_Demo;//_TARGET_AL;
    cmd.COMMAND_DATA.USER_COMMAND = SCI_DEMO;
    cmd.COMMAND_DATA.USER_PARA_INT[3] = WST_ZERO;
    pLAN->SendCommand(cmd);

    ui->BTN_WST_ZERO->setDisabled(true);
}

void OriginalDemoDialog::on_BTN_CAN_CHECK_clicked(){
    USER_COMMAND cmd;
...
void OriginalDemoDialog::on_BTN_FINDHOME_RIGHT_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_COMMAND = DAEMON_INIT_FIND_HOME;
    cmd.COMMAND_DATA.USER_PARA_CHAR[0] = -2; // all
    cmd.COMMAND_TARGET = RBCORE_PODO_NO;
    pLAN->SendCommand(cmd);
}

void OriginalDemoDialog::on_BTN_INIT_HEAD_clicked(){
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_COMMAND = DAEMON_INIT_FIND_HOME_HAND_HEAD;
    cmd.COMMAND_DATA.USER_PARA_CHAR[0] = 0; // right
    cmd.COMMAND_DATA.USER_PARA_CHAR[1] = 0; // left
    cmd.COMMAND_DATA.USER_PARA_CHAR[2] = 1; // head
    cmd.COMMAND_TARGET = RBCORE_PODO_NO;
    pLAN->SendCommand(cmd);
}

void OriginalDemoDialog::on_BTN_PODO_CONNECT_clicked()
{
//    LANDialog::on_BTN_LAN_CONNECT_clicked()
}

void OriginalDemoDialog::on_BTN_MOTION_SCENE_1_clicked()
{
    GeneralCommand(ALNum_Demo,DEMO_SCENE_1, 150);
    ChangeFace(0x02);

    //demoSound[150]->play();
        ui->BTN_MOTION_SCENE_1->setDisabled(true);
//        usleep(10*1000*1000);
//    ChangeFace(0x01);
}

void OriginalDemoDialog::on_BTN_MOTION_SCENE_2_clicked()
{
//    GeneralCommand(ALNum_Demo,106, 151);
    ChangeFace(0x01);
    GeneralCommand(ALNum_Demo,DEMO_SCENE_2, 151);
    ui->BTN_MOTION_SCENE_2->setDisabled(true);
}

void OriginalDemoDialog::on_BTN_MOTION_SCENE_3_clicked()
{
    GeneralCommand(ALNum_Demo,DEMO_SCENE_3, 152);
    ChangeFace(0x01);

    ui->BTN_MOTION_SCENE_3->setDisabled(true);
}

void OriginalDemoDialog::on_BTN_MOTION_SCENE_4_clicked()
{
    ChangeFace(0x02);
        GeneralCommand(ALNum_Demo,DEMO_SCENE_4, 153);
    ui->BTN_MOTION_SCENE_4->setDisabled(true);
//    usleep(10*1000*1000);
//    ChangeFace(0x01);
}

void OriginalDemoDialog::on_BTN_ENABLE_SCENE_clicked()
{
    ChangeFace(0x01);
    ui->BTN_MOTION_SCENE_1->setDisabled(false);
    ui->BTN_MOTION_SCENE_2->setDisabled(false);
    ui->BTN_MOTION_SCENE_3->setDisabled(false);
    ui->BTN_MOTION_SCENE_4->setDisabled(false);

//    ui->btn_hand_init->setDisabled(false);
//    ui->btn_hand_goff->setDisabled(false);
//    ui->btn_hand_gon->setDisabled(false);
//    ui->btn_hand_ready->setDisabled(false);
}

void OriginalDemoDialog::on_BTN_AL_RUN_clicked(){
    USER_COMMAND cmd;
...
void OriginalDemoDialog::on_BTN_HUBO_RUN_clicked()
{
...
void OriginalDemoDialog::on_BTN_AL_RUN_2_clicked()
{
    USER_COMMAND cmd;
...
void OriginalDemoDialog::on_BTN_HUBO_RUN_2_clicked()
{

    USER_COMMAND cmd1;
    cmd1.COMMAND_DATA.USER_PARA_CHAR[0] = true;     // enable
    cmd1.COMMAND_DATA.USER_COMMAND = DAEMON_MOTION_REF_ONOFF;
    cmd1.COMMAND_TARGET = RBCORE_PODO_NO;
    pLAN->SendCommand(cmd1);
}

void OriginalDemoDialog::on_BTN_FACE_SCENE_1_clicked(){
    ChangeFace(0x02);
}

void OriginalDemoDialog::on_BTN_FACE_SCENE_2_clicked()
{
    ChangeFace(0x01);
}

void OriginalDemoDialog::on_BTN_FACE_SCENE_3_clicked()
{
    ChangeFace(0x03);
}

void OriginalDemoDialog::on_BTN_FACE_SCENE_4_clicked()
{
//    ChangeFace(0x05);
}

void OriginalDemoDialog::on_BTN_FACE_SIMPLE_2_clicked()
{
    ChangeFace(0x01);
}

void OriginalDemoDialog::on_BTN_FACE_SMILE_2_clicked()
{
    ChangeFace(0x02);
}

void OriginalDemoDialog::on_BTN_WALK_READY_POS_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_TARGET = ALNumWalkReady;
    cmd.COMMAND_DATA.USER_PARA_INT[0] = 0;
...
void OriginalDemoDialog::on_BTN_FACE_HUBO_2_clicked()
{
    ChangeFace(8);
}
