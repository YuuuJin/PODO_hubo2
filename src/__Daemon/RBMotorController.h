...
public:
    ...
    int     RBBoard_RequestEncoder(int mode, int fes = 0);
    ...
    // for old hubo boards
    int     RBBoard_SendReference2ch_old(int ref1, int ref2);
    int     RBBoard_SendReference3ch_old(int ref1, int ref2, int ref3);
    int     RBBoard_SendReference5ch_old(int ref1, int ref2, int ref3, int ref4, int ref5);
    int     RBBoard_SendReference_old(void);
