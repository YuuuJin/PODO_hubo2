...
int RBFTSensor::RBFT_RequestData(int _mode){
    ...
    mb.dlc = 2;
    //mb.id = 0x02;//SENSOR_REQUEST_CANID;
...
//    if(mb.status != RBCAN_NODATA){
//        //printf("FT sensor data in!!!");
//        MX = (double)((short)((mb.data[1]<<8)|mb.data[0]))/100.0f;
//        MY = (double)((short)((mb.data[3]<<8)|mb.data[2]))/100.0f;
//        if(BOARD_ID == 48){
//            FZ = (double)((short)((mb.data[5]<<8)|mb.data[4]))/10.0f*454.48f/466.86f;
//        }else if(BOARD_ID == 49){
//            FZ = (double)((short)((mb.data[5]<<8)|mb.data[4]))/10.0f*454.48f/452.70f;
//        }
////        MX = -(double)((short)((mb.data[2]<<8)|mb.data[1]))/100.0f;
////        MY = -(double)((short)((mb.data[4]<<8)|mb.data[3]))/100.0f;
////        FZ = -(double)((short)((mb.data[6]<<8)|mb.data[5]))/10.0f;
...
//        canHandler->RBCAN_ReadData(&mb);
//        if(mb.status != RBCAN_NODATA){
//            dAccRoll =  (double)((short)((mb.data[0] | (mb.data[1]<<8))));//(double)((short)((mb.data[0] | (mb.data[1]<<8))));
//            dAccPitch = (double)((short)((mb.data[2] | (mb.data[3]<<8))));//(double)((short)((mb.data[2] | (mb.data[3]<<8))));
////            dAccRoll =  (double)((short)((mb.data[1] | (mb.data[2]<<8))))*0.1;//(double)((short)((mb.data[0] | (mb.data[1]<<8))));
////            dAccPitch = (double)((short)((mb.data[3] | (mb.data[4]<<8))))*0.1;//(double)((short)((mb.data[2] | (mb.data[3]<<8))));
//            AccRoll = dAccRoll;//(double)((1.0f - 2.0f*RBCORE_PI*CutOffFeq*(double)RT_TIMER_PERIOD_MS/1000.0f)*AccRollOld + 2.0f*RBCORE_PI*CutOffFeq*(double)RT_TIMER_PERIOD_MS/1000.0f*(double)dAccRoll);
//            AccPitch = dAccPitch;//(double)((1.0f - 2.0f*RBCORE_PI*CutOffFeq*(double)RT_TIMER_PERIOD_MS/1000.0f)*AccPitchOld + 2.0f*RBCORE_PI*CutOffFeq*(double)RT_TIMER_PERIOD_MS/1000.0f*(double)dAccPitch);
//            AccRollOld = AccRoll;
//            AccPitchOld = AccPitch;
//            PITCH = AccPitch;///SFPitch;
//            ROLL = AccRoll;///SFRoll;
...
////            dAccRoll =  (((double)((short)((mb.data[1] | (mb.data[2]<<8)))))/4.0)*0.4625*0.001*9.81; //(short)((mb.data[1] & 0x00ff) + ((mb.data[2]<<8) & 0x0f00));//-(double)((short)((mb.data[1] | (mb.data[2]<<8))))*0.1;//(double)((short)((mb.data[0] | (mb.data[1]<<8))));

////            dAccPitch = (((double)((short)((mb.data[3] | (mb.data[4]<<8)))))/4.0)*0.4625*0.001*9.81;  //(double)((short)((mb.data[3] | (mb.data[4]<<8))))*0.1;//(double)((short)((mb.data[2] | (mb.data[3]<<8))));
//////            if(mb.channel==1)
//              //  std::cout<<"My value :"<<dAccRoll<< "    and     "<<dAccPitch<<"   ~~!!"<<std::endl;


////            AccRoll = dAccRoll;//dAccRoll*0.05 + AccRollOld*0.95;//(double)((1.0f - 2.0f*RBCORE_PI*CutOffFeq*(double)RT_TIMER_PERIOD_MS/1000.0f)*AccRollOld + 2.0f*RBCORE_PI*CutOffFeq*(double)RT_TIMER_PERIOD_MS/1000.0f*(double)dAccRoll);
////            AccPitch = dAccPitch;//dAccPitch*0.05 + AccPitchOld*0.95;//;//(double)((1.0f - 2.0f*RBCORE_PI*CutOffFeq*(double)RT_TIMER_PERIOD_MS/1000.0f)*AccPitchOld + 2.0f*RBCORE_PI*CutOffFeq*(double)RT_TIMER_PERIOD_MS/1000.0f*(double)dAccPitch);

////            PITCH = AccPitch;///SFPitch;
////            ROLL = AccRoll;///SFRoll;

////            VelRoll = VelRollOld*0.9 + 0.1*(dAccRoll - dAccRollOld);//(double)((1.0f - 2.0f*RBCORE_PI*CutOffFeq*RT_TIMER_PERIOD_MS/1000.0f)*VelRollOld + RT_TIMER_PERIOD_MS/1000.0f*AccRollOld);
////            VelRollOld = VelRoll;

////            VelPitch = VelPitchOld*0.9 + 0.1*(dAccPitch - dAccPitchOld);//(double)((1.0f - 2.0f*RBCORE_PI*CutOffFeq*RT_TIMER_PERIOD_MS/1000.0f)*VelPitchOld + RT_TIMER_PERIOD_MS/1000.0f*AccPitchOld);
////            VelPitchOld = VelPitch;

////            dAccRollOld = dAccRoll;
////            dAccPitchOld = dAccPitch;
