...
double _SSP_TIME = 1.3*0.8;
double _DSP_TIME = 1.3*0.2;
...
//    double SSP_TIME = 1.2*0.7;
//    double DSP_TIME = 1.2*0.3;
        ...
        for(int j=0; j<target_foot_filled; j++){
            ...
            if(cnt_2_time(w_cnt) <= (tempTime = tempTime + target_foot[j].time.dsp_time)){
                ...
                case MOVING_RIGHT:
                    if(target_foot[j].info == FOOTINFO_FIRST_STEP){
                        // first step
                        if(cnt_2_time(w_cnt) <= (tempTime-_DSP_TIME)){
                            // stay
                            window[i].zmp.x = trajectory_5th(curTime, temp_cur->time.dsp_time - _DSP_TIME,
                                                            (temp_pre->footprint.rfoot[0] + temp_pre->footprint.lfoot[0])/2.0,
                                                            (temp_pre->footprint.rfoot[0] + temp_pre->footprint.lfoot[0])/2.0);
                            window[i].zmp.y = trajectory_5th(curTime, temp_cur->time.dsp_time - _DSP_TIME,
                                                            (temp_pre->footprint.rfoot[1] + temp_pre->footprint.lfoot[1])/2.0,
                                                            (temp_pre->footprint.rfoot[1] + temp_pre->footprint.lfoot[1])/2.0);
                        }else{
                            // move
                            window[i].zmp.x = trajectory_5th(curTime - (tempTime-_DSP_TIME), _DSP_TIME,
                                                            (temp_pre->footprint.rfoot[0] + temp_pre->footprint.lfoot[0])/2.0,
                                                            temp_cur->footprint.lfoot[0]);
                            window[i].zmp.y = trajectory_5th(curTime-(tempTime-_DSP_TIME), _DSP_TIME,
                                                            (temp_pre->footprint.rfoot[1] + temp_pre->footprint.lfoot[1])/2.0,
...
//                                        printf("last step is right!!!!!!!!!!!!!!!!!!!!!!! \n");
                    if(last_foot_before_moving_leg == MOVING_RIGHT){
                        ...
                        if(curTime < _DSP_TIME){
                            if(curTime < 0.01)
//                              /  printf("%d  last step is right!!!!!!!!!!!!!!!!!!!!!!! \n",last_foot_before_moving_leg);
                            // move
                            window[i].zmp.x = trajectory_5th(curTime, _DSP_TIME,
                                                            temp_cur->footprint.lfoot[0],
                                                            (temp_cur->footprint.lfoot[0] + temp_cur->footprint.rfoot[0])/2.0);
                            window[i].zmp.y = trajectory_5th(curTime, _DSP_TIME,
                                                            temp_cur->footprint.lfoot[1],
...
void update_window_foot_ref(long w_cnt){
    double height = 0.1,tempTime,curTime=0;
    double ratio = 0.4;
        ...
        for(int j=0; j<target_foot_filled; j++){
            ...
            if(cnt_2_time(w_cnt) <= (tempTime = tempTime + target_foot[j].time.dsp_time)){
                ...
                case MOVING_RIGHT:
                    if(target_foot[j].info == FOOTINFO_FIRST_STEP){
                        // first step
                        if(cnt_2_time(w_cnt) <= (tempTime-_DSP_TIME)){    // stay
                        }else{                                      // move
                        }
                    }else{
                    }
...
//                    if(curTime <= temp_cur->time.ssp_time*0.2/5.)
//                    {
//                        // leg up
//                        window[i].right_foot_ref.x = trajectory_5th(curTime, temp_cur->time.ssp_time*0.2/5.,
//                                                                temp_pre->footprint.rfoot[0],
//                                                                temp_pre->footprint.rfoot[0]);
//                    }else if(curTime > temp_cur->time.ssp_time*0.2/5. && curTime <= temp_cur->time.ssp_time*4.4/5.)
//                    {
//                        // leg down
//                        window[i].right_foot_ref.x = trajectory_5th(curTime - temp_cur->time.ssp_time*0.2/5., temp_cur->time.ssp_time*4.2/5.,
//                                                                temp_pre->footprint.rfoot[0] ,
//                                                                temp_cur->footprint.rfoot[0]);
//                    }else
//                    {
////                        window[i].right_foot_ref.x = trajectory_5th(curTime - temp_cur->time.ssp_time*4.4/5., temp_cur->time.ssp_time*0.6/5.,
////                                                                temp_cur->footprint.rfoot[0],
////                                                                temp_cur->footprint.rfoot[0]);

//                        window[i].right_foot_ref.x = temp_cur->footprint.rfoot[0];//
...
//                    {
//                        // leg up
//                        window[i].right_foot_ref.y = trajectory_5th(curTime, temp_cur->time.ssp_time*0.2/5.,
//                                                                temp_pre->footprint.rfoot[1],
//                                                                temp_pre->footprint.rfoot[1]);
//                    }else if(curTime > temp_cur->time.ssp_time*0.2/5. && curTime <= temp_cur->time.ssp_time*4.4/5.)
//                    {
//                        // leg down
//                        window[i].right_foot_ref.y = trajectory_5th(curTime - temp_cur->time.ssp_time*0.2/5., temp_cur->time.ssp_time*4.2/5.,
//                                                                temp_pre->footprint.rfoot[1] ,
//                                                                temp_cur->footprint.rfoot[1]);
//                    }else
//                    {
...
////                                                                temp_cur->footprint.lfoot[0] ,
////                                                                temp_cur->footprint.lfoot[0]);
//                        window[i].right_foot_ref.y = temp_cur->footprint.rfoot[1];//
//                    }
                    ...
                    {
                        // leg up
                        window[i].right_foot_ref.x = trajectory_onecos(curTime, temp_cur->time.ssp_time*0.2/5.,
                                                                temp_pre->footprint.rfoot[0],
                                                                temp_pre->footprint.rfoot[0]);
                    }else if(curTime > temp_cur->time.ssp_time*0.2/5. && curTime <= temp_cur->time.ssp_time*3.8/5.)
                    {
                        // leg down
                        window[i].right_foot_ref.x = trajectory_onecos(curTime - temp_cur->time.ssp_time*0.2/5., temp_cur->time.ssp_time*3.6/5.,
                                                                temp_pre->footprint.rfoot[0] ,
                                                                temp_cur->footprint.rfoot[0]);
                    }else
                    {
...
//                                                                temp_cur->footprint.rfoot[0]);
                    ...
                    {
                        // leg up
                        window[i].right_foot_ref.y = trajectory_onecos(curTime, temp_cur->time.ssp_time*0.2/5.,
                                                                temp_pre->footprint.rfoot[1],
                                                                temp_pre->footprint.rfoot[1]);
                    }else if(curTime > temp_cur->time.ssp_time*0.2/5. && curTime <= temp_cur->time.ssp_time*3.8/5.)
                    {
                        // leg down
                        window[i].right_foot_ref.y = trajectory_onecos(curTime - temp_cur->time.ssp_time*0.2/5., temp_cur->time.ssp_time*3.6/5.,
                                                                temp_pre->footprint.rfoot[1] ,
                                                                temp_cur->footprint.rfoot[1]);
                    }else
                    {
...
//                    if(curTime <= temp_cur->time.ssp_time*2./5.){
//                        // leg up
//                        window[i].right_foot_ref.z = trajectory_5th(curTime, temp_cur->time.ssp_time*2./5.,
//                                                                temp_pre->footprint.rfoot[2],
//                                                                temp_pre->footprint.rfoot[2]+ height);
//                    }else{
//                        // leg down
//                        window[i].right_foot_ref.z = trajectory_5th(curTime - temp_cur->time.ssp_time*2./5., temp_cur->time.ssp_time*3./5.,
//                                                                temp_pre->footprint.rfoot[2]+ height,
//                                                                temp_pre->footprint.rfoot[2]);
//                    }
...
//                    if(curTime <= temp_cur->time.ssp_time*2./5.){
//                        // leg up
//                        window[i].right_foot_ref.z = trajectory_onecos(curTime, temp_cur->time.ssp_time*2./5.,
//                                                                temp_pre->footprint.rfoot[2],
//                                                                temp_pre->footprint.rfoot[2]+ height);
//                    }else{

//                        // leg down
//                        window[i].right_foot_ref.z = trajectory_onecos(curTime - temp_cur->time.ssp_time*2./5., temp_cur->time.ssp_time*3./5.,
//                                                                temp_pre->footprint.rfoot[2]+ height,
//                                                                temp_pre->footprint.rfoot[2]);
//                    }
                    ...
                    if(curTime <= temp_cur->time.ssp_time*1.8/5.){
                        // leg up
                        window[i].right_foot_ref.z = trajectory_onecos(curTime, temp_cur->time.ssp_time*1.8/5.,
                                                                temp_pre->footprint.rfoot[2],
                                                                temp_pre->footprint.rfoot[2]+ height);
                    }else{
                        // leg down
                        window[i].right_foot_ref.z = trajectory_onecos(curTime - temp_cur->time.ssp_time*1.8/5., temp_cur->time.ssp_time*3.2/5.,
                                                                temp_pre->footprint.rfoot[2]+ height,
                                                                temp_pre->footprint.rfoot[2]);
                    }
...
//                    {
//                        // leg up
//                        window[i].left_foot_ref.x = trajectory_5th(curTime, temp_cur->time.ssp_time*0.2/5.,
//                                                                temp_pre->footprint.lfoot[0],
//                                                                temp_pre->footprint.lfoot[0]);
//                    }else if(curTime > temp_cur->time.ssp_time*0.2/5. && curTime <= temp_cur->time.ssp_time*4.4/5.)
//                    {
//                        // leg down
//                        window[i].left_foot_ref.x = trajectory_5th(curTime - temp_cur->time.ssp_time*0.2/5., temp_cur->time.ssp_time*4.2/5.,
//                                                                temp_pre->footprint.lfoot[0] ,
//                                                                temp_cur->footprint.lfoot[0]);
//                    }else
//                    {
////                        window[i].left_foot_ref.x = trajectory_5th(curTime - temp_cur->time.ssp_time*4.4/5., temp_cur->time.ssp_time*0.6/5.,
////                                                                temp_cur->footprint.lfoot[0] ,
////                                                                temp_cur->footprint.lfoot[0]);
//                        window[i].left_foot_ref.x = temp_cur->footprint.lfoot[0];//
//                    }
...
//                    {
//                        // leg up
//                        window[i].left_foot_ref.y = trajectory_5th(curTime, temp_cur->time.ssp_time*0.2/5.,
//                                                                temp_pre->footprint.lfoot[1],
//                                                                temp_pre->footprint.lfoot[1]);
//                    }else if(curTime > temp_cur->time.ssp_time*0.2/5. && curTime <= temp_cur->time.ssp_time*4.4/5.)
//                    {
//                        // leg down
//                        window[i].left_foot_ref.y = trajectory_5th(curTime - temp_cur->time.ssp_time*0.2/5., temp_cur->time.ssp_time*4.2/5.,
//                                                                temp_pre->footprint.lfoot[1] ,
//                                                                temp_cur->footprint.lfoot[1]);
//                    }else
//                    {
...
////                                                                temp_cur->footprint.lfoot[0] ,
////                                                                temp_cur->footprint.lfoot[0]);
//                        window[i].left_foot_ref.y = temp_cur->footprint.lfoot[1];//
//                    }
...
//                    if(curTime <= temp_cur->time.ssp_time*2./5.){
//                        // leg up
//                        window[i].left_foot_ref.z = trajectory_5th(curTime, temp_cur->time.ssp_time*2./5.,
//                                                                temp_pre->footprint.lfoot[2],
//                                                                temp_pre->footprint.lfoot[2]+ height);
//                    }else{
//                        // leg down
//                        window[i].left_foot_ref.z = trajectory_5th(curTime - temp_cur->time.ssp_time*2./5., temp_cur->time.ssp_time*3./5.,
//                                                                temp_pre->footprint.lfoot[2]+ height,
//                                                                temp_pre->footprint.lfoot[2]);
//                    }
                  ...
                  //******************************* cosin function
                    ...
                    {
                        // leg up
                        window[i].left_foot_ref.x = trajectory_onecos(curTime, temp_cur->time.ssp_time*0.2/5.,
                                                                temp_pre->footprint.lfoot[0],
                                                                temp_pre->footprint.lfoot[0]);
                    }else if(curTime > temp_cur->time.ssp_time*0.2/5. && curTime <= temp_cur->time.ssp_time*3.8/5.)
                    {
                        // leg down
                        window[i].left_foot_ref.x = trajectory_onecos(curTime - temp_cur->time.ssp_time*0.2/5., temp_cur->time.ssp_time*3.6/5.,
                                                                temp_pre->footprint.lfoot[0] ,
                                                                temp_cur->footprint.lfoot[0]);
                    }else
                    {
...
//                                                                temp_cur->footprint.lfoot[1]);
                    ...
                    {
                        // leg up
                        window[i].left_foot_ref.y = trajectory_onecos(curTime, temp_cur->time.ssp_time*0.2/5.,
                                                                temp_pre->footprint.lfoot[1],
                                                                temp_pre->footprint.lfoot[1]);
                    }else if(curTime > temp_cur->time.ssp_time*0.2/5. && curTime <= temp_cur->time.ssp_time*3.8/5.)
                    {
                        // leg down
                        window[i].left_foot_ref.y = trajectory_onecos(curTime - temp_cur->time.ssp_time*0.2/5., temp_cur->time.ssp_time*3.6/5.,
                                                                temp_pre->footprint.lfoot[1] ,
                                                                temp_cur->footprint.lfoot[1]);
                    }else
                    {
...
//                    }
                    ...
                    if(curTime <= temp_cur->time.ssp_time*1.8/5.){
                        // leg up
                        window[i].left_foot_ref.z = trajectory_onecos(curTime, temp_cur->time.ssp_time*1.8/5.,
                                                                temp_pre->footprint.lfoot[2],
                                                                temp_pre->footprint.lfoot[2]+ height);
                    }else{
                        // leg down
                        window[i].left_foot_ref.z = trajectory_onecos(curTime - temp_cur->time.ssp_time*1.8/5., temp_cur->time.ssp_time*3.2/5.,
                                                                temp_pre->footprint.lfoot[2]+ height,
                                                                temp_pre->footprint.lfoot[2]);
                    }
