...
//        m_lf1 = 0.001;
        ...
        m_pel = 0.3*2 + 0.5542*2 + 2.3147*2 + 3.88 + 8.8;
        ...
        SC2S = 0.2145;//0.2145; // shoulder center to shoulder
        UARM = 0.17914;//0.17914;
        LARM = 0.1222+0.04041;
        OFFELB = 0.022;
...
//        c_pel = vec3(+0.006, -0.00, 0.28);
        //c_pel = vec3(-0.0164, -0.00, 0.2757); from Solidworks
        c_pel = vec3(-0.04, -0.00, 0.40);
        ...
        //centerofmass_lb
        c_rhy = vec3(-0.00, -0.000, 0.00);
        c_rhr = vec3(0.000, 0.000, -0.00);
        c_rhp = vec3(0.0175,-0.0099,-0.0995);
        c_rkn = vec3(0.0146,-0.0146,-0.1845);
        c_rap = vec3(0.0, 0.0, 0.0);
        c_rar = vec3(0.0216, -0.0014, -0.0160);

        c_lhy = vec3(-0.00, -0.000, 0.00);
        c_lhr = vec3(0.0004, -0.0024, -0.0247);
        c_lhp = vec3(0.0175,0.0099,-0.0995);
        c_lkn = vec3(0.0146,0.0146,-0.1845);
        c_lap = vec3(0.0, 0.0, 0.0);
        c_lar = vec3(0.0216, 0.0014, -0.0160);
