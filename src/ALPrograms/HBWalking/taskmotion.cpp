...
void TaskMotion::RefreshToCurrentReference_HB(double _RFx_ankle_con_deg, double _RFy_ankle_con_deg, double _LFx_ankle_con_deg, double _LFy_ankle_con_deg){
    ...
    LJ.RHP = Joint->GetJointRefAngle(RHP)*D2R;
    LJ.RKN = Joint->GetJointRefAngle(RKN)*D2R;
    LJ.RAP = Joint->GetJointRefAngle(RAP)*D2R - _RFy_ankle_con_deg*D2R;
    LJ.RAR = Joint->GetJointRefAngle(RAR)*D2R - _RFx_ankle_con_deg*D2R;
//    //for gazelle
//    double RAP_deg, RAR_deg;
//    GK.FK_diff_Ankle_right(Joint->GetJointRefAngle(RAP), Joint->GetJointRefAngle(RAR), 0, 0, RAP_deg, RAR_deg);
//    LJ.RAP = RAP_deg*D2R;
...
//    cout<<"RAR_deg : "<<RAR_deg<<endl;
    ...
    LJ.LHP = Joint->GetJointRefAngle(LHP)*D2R;
    LJ.LKN = Joint->GetJointRefAngle(LKN)*D2R;
    LJ.LAP = Joint->GetJointRefAngle(LAP)*D2R - _LFy_ankle_con_deg*D2R;
    LJ.LAR = Joint->GetJointRefAngle(LAR)*D2R - _LFx_ankle_con_deg*D2R;
//    //for gazelle
//    double LAP_deg, LAR_deg;
//    GK.FK_diff_Ankle_left(Joint->GetJointRefAngle(LAP), Joint->GetJointRefAngle(LAR),0,0,LAP_deg, LAR_deg);
//    LJ.LAP = LAP_deg*D2R;
