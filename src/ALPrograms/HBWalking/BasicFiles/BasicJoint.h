...
//        GK.FK_diff_Ankle(Shm_sen->ENCODER[4][0].CurrentReference, Shm_sen->ENCODER[5][0].CurrentReference,0,0,RAP_deg,RAR_deg);

//        Joints[4]->SetRefAngleCurrent(RAP_deg);
//        Joints[5]->SetRefAngleCurrent(RAR_deg);
//        Shm_ref->JointReference[PODONum][4][0] = Joints[4]->GetRefAngleCurrent();
//        Shm_ref->JointReference[PODONum][5][0] = Joints[5]->GetRefAngleCurrent();

//        double LAP_deg, LAR_deg;
//        GK.FK_diff_Ankle(Shm_sen->ENCODER[10][0].CurrentReference, Shm_sen->ENCODER[11][0].CurrentReference,0,0,LAP_deg,LAR_deg);

//        Joints[10]->SetRefAngleCurrent(LAP_deg);
//        Joints[11]->SetRefAngleCurrent(LAR_deg);
//        Shm_ref->JointReference[PODONum][10][0] = Joints[10]->GetRefAngleCurrent();
//        Shm_ref->JointReference[PODONum][11][0] = Joints[11]->GetRefAngleCurrent();

    }

    void    RefreshToCurrentPosition(){ //Hyobin added
        int mcId, mcCh;
        for(int i=0; i<NO_OF_JOINTS; i++){
            Joints[i]->SetMoveFlag(false);
            mcId = Joints[i]->MCId;
        ...
        //gazelle
//        double RAP_deg, RAR_deg;
//        GK.FK_diff_Ankle(Shm_sen->ENCODER[4][0].CurrentPosition, Shm_sen->ENCODER[5][0].CurrentPosition,0,0,RAP_deg,RAR_deg);
...
//        double LAP_deg, LAR_deg;
//        GK.FK_diff_Ankle(Shm_sen->ENCODER[10][0].CurrentPosition, Shm_sen->ENCODER[11][0].CurrentPosition,0,0,LAP_deg,LAR_deg);
